...
def view_location(Location):
    ...
    sql_user = "select Day,Slot,Batch,Location,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '1'"
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '2'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '3'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '4'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '5'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '6'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '7'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
    ...
    sql_user = "select Day,Slot,Location,Batch,Subject,Faculty from master_sem1 where Location = '"+Location+"' and Slot = '8'"
    user_result = connection.execute(sql_user)
    user_res = user_result.fetchall()
    user_res_str = str(user_res)
    #print (user_res)
